...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 max-h-min w-64 p-4 shadow-xl shadow-blue-gray-900/5 dark:bg-[#151725] dark:text-white z-30">
